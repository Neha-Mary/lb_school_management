...
class OfficeStaffDeleteView(generics.DestroyAPIView):
    def delete(self,request,*args,**kwargs):
        ...
        if not confirm:
            return Response(
                {
                    "message": "Are you sure you want to delete this Office staff?",
                    "custom_id": custom_id,
                    "note": "Send 'confirm: true' in the request body to proceed."
                },
...
class LibrarianDeleteView(generics.DestroyAPIView):
    def delete(self,request,*args,**kwargs):
        ...
        if not confirm:
            return Response(
                {
                    "message": "Are you sure you want to delete this librarian?",
                    "custom_id": custom_id,
                    "note": "Send 'confirm: true' in the request body to proceed."
                },
                status=status.HTTP_200_OK
...
class StudentDetailView(APIView):
    ...
    def delete(self,request):
        ...
        if not confirm:  # If confirmation not provided, ask for it
            return Response(
                {
